...
st.caption("Cálculo de área, perímetro y localización (WGS-84 Zona 18S)")
...
if len(df_coords) >= 3:
    ...
    st.markdown("---")
    st.subheader("3. Ubicación Satelital")
    ...
    col_link1.link_button("🌐 Abrir en Google Earth", url_ge, use_container_width=True)
